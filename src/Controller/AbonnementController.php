...
class AbonnementController extends AbstractController
{
    ...
    {
        return $this->render('abonnement/home2.html.twig', [
            'abonnements' => $abonnementRepository->findAll(),
        ]);
    }

    #[Route('/salle', name: 'app_abonnement_index2', methods: ['GET'])]
    public function index2(AbonnementRepository $abonnementRepository): Response
    {
        return $this->render('abonnement/salle.html.twig', [
            'abonnements' => $abonnementRepository->findAll(),
        ]);
    }
    #[Route('/back', name: 'app_abonnement_index3', methods: ['GET'])]
    public function index3(AbonnementRepository $abonnementRepository): Response
    {
